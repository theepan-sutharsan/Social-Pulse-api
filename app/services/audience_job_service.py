            ...
            for batch_number in range(total_batches):
                ...
                for comment in batch:
                    ...
                    analysis = AudienceCommentAnalysis(
                        ...
                        is_toxic=classification["toxic"],
                        toxicity_severity=classification["toxicity_severity"],
                        is_sarcastic=classification["sarcastic"],
                        bot_signal=classification["bot_signal"],
